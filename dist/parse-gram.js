...
(function(){
  var fs, gramItems, gramSymbolRepeter, gramOptional, gramLineParse, gramOr, gramEscape, gramUnescape, gramLineDecl, stdGram, join$ = [].join, slice$ = [].slice;
  fs = require('fs');
  gramItems = {};
  gramSymbolRepeter = function(){};
  gramOptional = function(){};
